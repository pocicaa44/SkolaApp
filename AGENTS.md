...
- Workspace ID: `be796cfe-ad42-4bc1-811a-0697ed66df09`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/be796cfe-ad42-4bc1-811a-0697ed66df09.
...
2. `npx ngodingpakeai connect --workspace be796cfe-ad42-4bc1-811a-0697ed66df09 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/be796cfe-ad42-4bc1-811a-0697ed66df09. Only pass on links the CLI actually printed — never assemble one from an id yourself.
